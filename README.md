...
```bash
# Linux
sha256sum "1-Deck Casino Card BIP-39 Seed Generator v2.13.html"

# macOS
shasum -a 256 "1-Deck Casino Card BIP-39 Seed Generator v2.13.html"
```
```powershell
# Windows
Get-FileHash -Algorithm SHA256 "1-Deck Casino Card BIP-39 Seed Generator v2.13.html"
```

Expected:

```
1e7a1754b6f7ce53085917a82c237bb2086d2430112c443c1d27ab02ec60c45f
```
...
| File | |
|---|---|
| `1-Deck Casino Card BIP-39 Seed Generator v2.13.html` | the tool — one self-contained file |
...
| `examples/` | an example seed record and blank draw sheet |
